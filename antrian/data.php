            ...
            <div class="box">
                ...
                <h4 class="mb-4">
                    ...
                    <div class="text-right">
                        <a href="add.php" class="btn btn-warning btn-lg ml-auto bg-gradient"><i
                                class="glyphicon glyphicon-chevron-left"></i> Kembali</a>
                    </div>
                </h4>
                <div class="card">
                    <div class="card-header bg-secondary bg-gradient text-white display-6 text-center">
                        Cek Antrian
                    </div>
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama_pasien"
                                    class="form-control form-control-lg flex-grow-1" required autofocus
